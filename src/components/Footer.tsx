    ...
    <footer className="bg-gray-900 py-12">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-5">
          ...
          {/* Courses */}
          <div>
            <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-gray-400">Courses</h4>
            <ul className="space-y-2">
              <li><Link href="/courses/sat" className="text-sm text-gray-300 hover:text-white transition-colors">SAT Prep</Link></li>
              <li><Link href="/courses/act" className="text-sm text-gray-300 hover:text-white transition-colors">ACT Prep</Link></li>
              <li><Link href="/courses/psat" className="text-sm text-gray-300 hover:text-white transition-colors">PSAT Prep</Link></li>
              <li><Link href="/courses/ap" className="text-sm text-gray-300 hover:text-white transition-colors">AP Prep</Link></li>
              <li><Link href="/classes/personalised" className="text-sm text-gray-300 hover:text-white transition-colors">1:1 Classes</Link></li>
              <li><Link href="/classes/self-paced" className="text-sm text-gray-300 hover:text-white transition-colors">Self-Paced</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Refund Policy</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-gray-800 pt-8 md:flex-row">
          <p className="text-sm text-gray-500">&copy; {new Date().getFullYear()} Catalyst Test Prep. All rights reserved.</p>
          <div className="flex gap-4">
            ...
            <a href="https://chat.whatsapp.com/placeholder" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-white transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
