        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            <a href="#" className="text-xl font-bold text-white">
              Catalyst<span className="text-green-400">.</span>
            </a>
            <p className="mt-3 text-sm text-gray-400">
              Personalized 1-on-1 online SAT prep with a score improvement guarantee.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#tutors" className="text-sm text-gray-300 hover:text-white transition-colors">Our Tutors</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">SAT Resources</a></li>
