                      ...
                      <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
                        {/* Left Column */}
                                <div className="flex-1 lg:max-w-[55%]">
                                            <h1 className="text-4xl font-bold leading-tight text-heading md:text-5xl" style={{ maxWidth: "600px" }}>
                                                          ...
                                                          <span className="text-green-primary">— Guaranteed</span>span>
                                            </h1>h1>
                          ...
                          <div key={item} className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-heading">{item}</span>span>
                          </div>div>
                        ))}
                                            </div>div>
                                            <div className="mt-8 flex items-center gap-6">
                                                          <span className="text-xs text-caption">As seen in</span>span>
                                                          <div className="flex items-center gap-5 opacity-70">
                                                                          <span className="text-sm font-semibold text-gray-400">AP News</span>span>
                                                                          <span className="text-sm font-semibold text-gray-400">Outlook India</span>span>
                                                          </div>div>
                                            </div>div>
                        ...
                        {/* Right Column — Multi-Step Form */}
                          ...
                          <div className="flex flex-col items-center py-6 text-center">
                                            ...
                                            <h3 className="text-xl font-bold text-heading">You&apos;re all set!</h3>h3>
                                            <p className="mt-2 text-sm text-body">We&apos;ll be in touch within 24 hours to schedule your free trial session.</p>p>
                          </div>div>
                        ) : (
                          <>
                            ...
                            {step === 1 && (
                                                <div>
                                                                      <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-green-primary">America&apos;s #1 SAT Prep Platform</p>p>
                                                                      <h2 className="mb-6 text-xl font-bold text-heading">Who will be getting tutoring?</h2>h2>
                            ...
                            {step === 2 && (
                                                <div>
                                                                      <h2 className="mb-6 text-xl font-bold text-heading">How soon would you like to get started?</h2>h2>
                                                                      <div className="flex flex-col gap-3">
                            ...
                            {step === 3 && (
                                                <div>
                                                                      <h2 className="mb-2 text-xl font-bold text-heading">Let&apos;s find you the perfect tutor</h2>h2>
                                                                      <p className="mb-5 text-sm text-body">Fill in your details and we&apos;ll match you with a top SAT specialist.</p>p>
                            ...
                            {step === 4 && (
                                                <div>
                                                                      <h2 className="mb-2 text-xl font-bold text-heading">Almost there!</h2>h2>
                                                                      <p className="mb-5 text-sm text-body">Select the student&apos;s current grade to personalise your prep plan.</p>p>
                                                                      <form onSubmit={handleFinalSubmit} className="flex flex-col gap-4">
                                                                                              <select value={formData.grade} onChange={(e) => setFormData({ ...formData, grade: e.target.value })} className="rounded-lg border border-gray-300 px-4 py-3 text-sm text-heading transition-colors focus:border-green-primary focus:ring-1 focus:ring-green-primary" required>
                                                                                                                        <option value="" disabled>Select Grade</option>option>
                                                                                                {["Grade 8", "Grade 9", "Grade 10", "Grade 11", "Grade 12"].map((g) => (
                                                                              <option key={g} value={g}>{g}</option>option>
                                                                            ))}
                                                                                                </select>select>
                                                                                              <button type="submit" className="mt-2 w-full rounded-lg bg-green-primary py-3.5 text-base font-bold text-white transition-colors hover:bg-green-dark">
                                                                      ...
                                                                      <div className="mt-4 flex items-center justify-center gap-6 text-center">
                                                                        {[["10M+", "Hours of Live Instruction"], ["10K+", "5-Star Reviews"], ["40K+", "Expert Tutors"]].map(([num, label]) => (
                                                                            <div key={num}>
                                                                                                        <p className="text-lg font-bold text-green-primary">{num}</p>p>
                                                                                                        <p className="text-xs text-caption">{label}</p>p>
                                                                              </div>div>
                                                                          ))}
                                                                      </div>div>
                                                </div>div>
