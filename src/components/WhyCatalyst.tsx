        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <AnimateOnScroll key={i} animation="fade-up" delay={i * 100}>
              <div className="hover-lift flex h-full flex-col rounded-xl border border-gray-100 bg-white p-8 shadow-sm">
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-green-light transition-all duration-300 hover:bg-green-primary hover:text-white [&:hover_svg]:text-white">
                  {feature.icon}
                </div>
