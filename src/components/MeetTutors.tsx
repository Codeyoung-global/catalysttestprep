      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <AnimateOnScroll animation="fade-up">
          <div className="mb-12 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <Link href="#hero-form" className="shrink-0 rounded-lg bg-green-primary px-6 py-3 text-sm font-bold text-white transition-all hover:bg-green-dark hover:shadow-lg">
        ...
        <AnimateOnScroll animation="fade-up" delay={150}>
          <div className="relative">
            {/* Tutor Cards Row - Horizontal scroll on mobile */}
              ...
              {tutors.map((tutor, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="text-center text-sm font-bold text-heading md:text-base">{tutor.name}</h3>
        ...
        <div className="slider-slide-enter mt-10 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm md:p-8" key={activeTutor.id}>
            ...
            <div className="flex flex-col gap-5 lg:w-[340px] lg:shrink-0">
              ...
              >
                <div className="flex flex-col items-center gap-2 text-center">
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-green-primary/90 text-white shadow-lg transition-transform hover:scale-110">
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                {[
                  ...
                  <div key={lbl} className="rounded-xl bg-bg-alt p-3">
                    <p className="text-base font-bold text-green-primary md:text-lg">{val}</p>
