    ...
    >
      <div className="mx-auto flex max-w-3xl flex-col items-center px-6 text-center">
        ...
        <p className="mb-8 max-w-xl text-lg leading-relaxed text-white/90">
          Get daily SAT tips, study resources, score improvement strategies, and
          exclusive updates delivered straight to your phone. Connect with fellow
          students and our expert tutors.
        </p>
        ...
        <p className="mt-4 text-sm text-white/70">
          Free to join &middot; 2,000+ members &middot; Daily tips &amp; resources
        </p>
      </div>
    </section>
  );
