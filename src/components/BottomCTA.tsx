    ...
    <section className="bg-surface-dark" style={{ padding: "var(--section-gap) 0" }}>
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <AnimateOnScroll animation="scale-in" delay={200}>
          <a
            href="#hero-form"
            className="inline-block rounded-lg bg-green-primary px-10 py-4 text-lg font-bold text-white transition-all hover:bg-green-dark hover:scale-105 hover:shadow-lg hover:shadow-green-primary/20"
          >
